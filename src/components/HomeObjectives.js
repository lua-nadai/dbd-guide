            ...
            <div className='objective-container'>
                ...
                <div className='objective-box center'>
                    <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', width: '20vw' }}>
                        <img src='https://i.psnprofiles.com/guides/9456/d354fa.png'/>
                        <h2>HOW TO WIN</h2>
                    </div>
                ...
                <div className='objective-box center'>
                    <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', width: '20vw' }}>
                        <img src='https://i.psnprofiles.com/guides/6993/212d9b.png'/>
                        <h2>STEALTH</h2>
                    </div>
                ...
                <div className='objective-box center'>
                    <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', width: '20vw' }}>
                        <img src='https://i.psnprofiles.com/guides/6993/d04296.png'/>
                ...
                <div className='objective-box center'>
                    <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', width: '20vw' }}>
                        <img src='https://i.psnprofiles.com/guides/6993/f054a4.png'/>
                ...
                <div className='objective-box center'>
                    <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', width: '20vw' }}>
                        <img src='https://i.psnprofiles.com/guides/6993/065a43.png'/>
                        <h2>GENERATORS</h2>
                    </div>
                ...
                <div className='objective-box center'>
                    <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', width: '20vw' }}>
                        <img src='https://i.psnprofiles.com/guides/6993/517035.png'/>
                        <h2>SKILL CHECKS</h2>
                    </div>
                ...
                <div className='objective-box center'>
                    <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', width: '20vw' }}>
                        <img src='https://i.psnprofiles.com/guides/6993/0b98ba.png'/>
                        <h2>ESCAPING</h2>
                    </div>
    ...
    return (
        <section className='center'>
            ...
            <div className='objective-container'>
                ...
                <div className='objective-box center'>
                    <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', width: '20vw'}}>
                        <img src='https://i.psnprofiles.com/guides/6993/a7d53b.png'/>
                        <h2>HOW TO WIN</h2>
                    </div>
                ...
                <div className='objective-box center'>
                    <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', width: '20vw' }}>
                        <img src='https://i.psnprofiles.com/guides/6993/7ef0f5.png'/>
                        <h2>HUNTING</h2>
                    </div>
                    <p>
                ...
                <div className='objective-box center'>
                    <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', width: '20vw' }}>
                        <img src='https://i.psnprofiles.com/guides/10790/db47d5.png'/>
                ...
                <div className='objective-box center'>
                    <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', width: '20vw' }}>
                        <img src='https://i.psnprofiles.com/guides/6661/ab7dad.png'/>
                        <h2>ATTACKING</h2>
                    </div>
                ...
                <div className='objective-box center'>
                    <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', width: '20vw' }}>
                        <img src='https://i.psnprofiles.com/guides/10377/6b166c.png'/>
                ...
                <div className='objective-box center'>
                    <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', width: '20vw' }}>
                        <img src='https://i.psnprofiles.com/guides/10377/0df3d8.png'/>
                        <h2>SACRIFICE</h2>
                    </div>
                    <p>
